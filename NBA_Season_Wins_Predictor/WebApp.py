...
st.text('Normally the Estimated NET Rating value is similar to normal NET rating so for this model to work well they values for both should be in a similar range to each other')
